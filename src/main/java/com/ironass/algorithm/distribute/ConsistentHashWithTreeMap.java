...
public class ConsistentHashWithTreeMap<T> {
    /**
     ...
     * @param nodes            节点对象
     */
    public ConsistentHashWithTreeMap(int numberOfReplicas, Collection<T> nodes) {
...
//                return fnv1HashingAlg(key.toString());
     ...
     * @param nodes            节点对象
     */
    public ConsistentHashWithTreeMap(HashFunc hashFunc, int numberOfReplicas, Collection<T> nodes) {
        this.numberOfReplicas = numberOfReplicas;
